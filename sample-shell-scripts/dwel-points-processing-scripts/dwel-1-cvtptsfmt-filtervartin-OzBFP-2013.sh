...
$ML "addpath(genpath('$BASEDIR')); EVIPtsPathName='${EVIPTSPATHNAMES[$SGE_TASK_ID-1]}'; EVIPtsFileName='${EVIPTSFILENAMES[$SGE_TASK_ID-1]}'; InPtsPathName='$INPTSPATHNAME'; InPtsFileName='$INPTSFILENAME'; GroundPtsPathName=InPtsPathName; GroundPtsFileName='$GROUNDPTSFILENAME'; run Script1_CvtPtsFmt; run Script2_FilteringVarTIN"
