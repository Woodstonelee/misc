...
#$ -pe omp 1
#$ -l h_rt=24:00:00
#$ -N dwel-points-3-1064-OzBFP-2013
#$ -V
#$ -t 1-5
...
MODELFPFILENAME="Aug3_BFP_C_1064_Cube_NadirCorrect_Aligned_nu_basefix_satfix_pfilter_b32r04_at_project_ptcl_points.fp"
...
MATCHEDFILENAMES=( \
  "brisbane-bfp-automatch-trkctr-1064-e2c.txt" \
  "brisbane-bfp-automatch-trkctr-1064-s2c.txt" \
  "brisbane-bfp-automatch-trkctr-1064-w2c.txt" \
  "brisbane-bfp-automatch-trkctr-1064-c12c.txt" \
  "brisbane-bfp-automatch-trkctr-1064-c22c.txt" \
)
