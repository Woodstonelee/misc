%% Analysis of cal_oz_20140425_0503 panel returns at 1064 nm after noise returns
%% furhther reduced
...
inwirefiles = { ...
'cal_oz_20140425_0_5_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_10_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_11_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_12_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_13_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_14_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_15_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_1_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_1_5_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_20_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_25_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_2_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_2_5_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_30_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_35_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_3_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_3_5_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_40_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_4_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_4_5_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_50_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_5_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_5_5_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_60_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_6_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_6_5_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_70_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_7_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_7_5_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_8_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_8_5_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_9_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
'cal_oz_20140425_9_5_1064_cube_bsfix_pxc_update_filtfix_wire.log' ...
};
...
indexfile = '/usr3/graduate/zhanli86/Programs/misc/dwel-static-scan-analysis/cal-oz-uml-hf-20140425-0503/cal_oz_20140425_0503_select_shots_1064.csv'; 

timebin = 0.1; % ns
dnbin = 1; % dn

numpanels = 4;
%panelrefl = [0.987, 0.436, 0.320, 0.041];
panelrefl = [0.987, 0.5145, 0.3828, 0.0432];
...
refinedoutfile = 'cal_oz_20140425_0503_panel_returns_refined_stats_1064.txt';

scaleoutfile = 'cal_oz_20140425_0503_laser_power_scale_factors_1064.txt';
...
for fnum=1:numfiles
  ...
  if plotflag
    ...
    set(hax(2), 'ycolor', 'b')
    title(['Extracted and refined points of panel returns from 1064 nm at ', num2str(panelrange), ...
           'm']);
  ...
  if plotflag
    ...
    figh = figure('Name', ['Wire signal at 1064 nm at ', num2str(panelrange), 'm'], ...
           'Visible', 'off');
    subplot(2,2,1);
    hist(wiredata(:,1), min(wiredata(:,1)):timebin:max(wiredata(:,1)));
    xlabel('T_0');
    ylabel('frequency');
    title(['Histogram of T_0 at 1064 nm at ', num2str(panelrange), ' m']);
    subplot(2,2,2);
    hist(wiredata(:,2), min(wiredata(:,2)):dnbin:max(wiredata(:,2)));
    xlabel('T_0 intensity');
    ylabel('frequency');
    title(['Histogram of T_0 intensity at 1064 nm at ', num2str(panelrange), ' m']);
    subplot(2,2,3);
...
% axis([0,70,0,1000]);
title('Panel returns 20140812 at 1064 nm, statistics');
...
figure('Name', '1064 nm panel returns normalized by reflectance');
markerstr = {'o-r', 'o-g', 'o-b', 'o-c'};
ebh = nan(numpanels, 1);
for pnum=1:numpanels
    x = rg_mean(:, pnum);
...
axis([0,70,0,1000]);
title('Panel returns 20140812 at 1064 nm, normalized by reflectance');
legend(ebh, 'Lambertian panel', 'Gray panel 1', 'Gray panel 2', 'Black panel');
...
figure('Name', '1064 nm wire signal intensity');
markerstr = {'o-r', 'o-g', 'o-b', 'o-c'};
ebh = nan(numpanels, 1);
for pnum=1:numpanels
    x = rg_mean(:, pnum);
...
title('Wire returns 20140812 at 1064 nm, statistics');
legend(ebh, 'Lambertian panel', 'Gray panel 1', 'Gray panel 2', 'Black panel');
...
fprintf('Laser power baseline DN for 1064 nm: %d\n', baseint);
...
% 6m. 
figure('Name', '1064 nm panel returns refined statistics, laser power correction');
markerstr = {'o-r', 'o-g', 'o-b', 'o-c'};
ebh = nan(numpanels, 1);
% scale_ratios = zeros(numfiles, numpanels);
...
% axis([0,70,0,1000]);
title('Panel returns 20140812 at 1064 nm, statistics, laser power variation corrected');
...
figure('Name', ['1064 nm panel returns normalized by reflectance after laser ' ...
...
axis([0,70,0,1000]);
title(['Panel returns 20140812 at 1064 nm, laser power variation corrected, ' ...
...
% title('Logorithm of lidar equation for DWEL 1064 nm');
% legend(ebh, 'Lambertian panel', 'Gray panel 1', 'Gray panel 2');
...
% xlabel('$\ln(r)$', 'Interpreter','LaTex');
% ylabel('$\ln(\rho) - \ln(P_r)$', 'Interpreter','LaTex');
% title('fitting to logorithm of lidar equation for DWEL 1064 nm');
...
% xlabel('range');
% ylabel('K(r)');
% title('Telescope efficiency data points for DWEL 1064 nm');
% legend(ebh, 'Lambertian panel', 'Gray panel 1', 'Gray panel 2');
