...
#$ -l mem_total=2
#$ -l h_rt=24:00:00
#$ -N dwel-wf-cal-nsf-20140812-1064
#$ -V
#$ -m ae
#$ -t 1-33
...
# # $IDL "envi, /restore_base_save_files & envi_batch_init, /no_status_window & dwel_static_hdf2cube, '${HDF5FILES[$SGE_TASK_ID-1]}', '$FILENAME', 1548, 1064, 0.0, 2.5, 2.0"
