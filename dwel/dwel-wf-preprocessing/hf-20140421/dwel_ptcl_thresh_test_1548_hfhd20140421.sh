...
#$ -l mem_total=8
#$ -l h_rt=72:00:00
#$ -N dwel-ptcl-thresh-test-1548-hfhd20140421
#$ -V
#$ -m ae
#$ -t 1-16

CUBEFILES="/projectnb/echidna/lidar/DWEL_Processing/HF2014/Hardwood20140421/HFHD20140421-C/HFHD_20140421_C_1548_cube.img"
