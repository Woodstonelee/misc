%% Evaluate and validate Oz DWEL with-wire calibration
...
% calibration parameter version 20150201
calpar1064 = [41814.210712,0.000041,0.383201,179684.900719,1.624434];
calpar1548 = [88358.376380,0.000041,0.445861,179684.900719,1.670923];

% get stats of app. refl. error in each range division
rgbreak1064 = [3.5, 6.5, 13, 40];
rgbreak1548 = [4, 10, 40];
% mean relative error in each range division from stats
rgbreakerrfixflag = false;
rgbreakerr1064 = [0.159, -0.063, 0];
rgbreakerr1548 = [0.074, -0.033];
