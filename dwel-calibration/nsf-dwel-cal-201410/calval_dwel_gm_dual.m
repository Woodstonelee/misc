...
calpar1064 = [5084.052,1198.004,0.899,13.485,1.366];
calpar1548 = [17930.134,12.316,0.595,4.866,1.535];
...
legend('boxoff');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_kr_mean_norm_data.png'), '-r300', '-png', '-painters');
...
legend('boxoff');
title('1064');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1064_average_data.png'), '-r300', '-png', '-painters');
...
title('1064');
legend('boxoff');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1064_average_data_scatter_plot.png'), '-r300', ...
           '-png', '-painters');
...
%legend('boxoff');
title('1064');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1064_average_data_apprefl_error.png'), '-r300', '-png', '-painters');
...
legend('boxoff');
title('1064');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1064_datasample.png'), '-r300', '-png', '-painters');
% plot scatter plot of modeled return intensity.
...
title('1064');
legend('boxoff');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1064_data_sample_scatter_plot.png'), '-r300', ...
           '-png', '-painters');
...
ylabel('\rho_{app}');
title('1064');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1064_data_sample_apprefl_range.png'), '-r300', '-png', '-painters');
...
% title('1064');
% legend('boxoff');
% export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1064_data_sample_apprefl_error.png'), '-r300', '-png', '-painters');
% % plot errors in apparent reflectance against range, expect no trend
% figure();
% export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1064_data_sample_apprefl_error_range.png'), '-r300', '-png', '-painters');
figure('Position', [0, 0, 2.17, 1.73]);
%subplot(1, 2, 1);
...
title('1064');
legend('boxoff');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1064_data_sample_apprefl_error_hist.png'), '-r300', '-png', '-painters');
...
legend('boxoff');
title('1548');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_average_data.png'), '-r300', '-png', '-painters');
% plot scatter plot of modeled return intensity.
...
title('1548');
legend('boxoff');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_average_data_scatter_plot.png'), '-r300', ...
           '-png', '-painters');
% plot apparent reflectance errors
...
%legend('boxoff');
title('1548');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_average_data_apprefl_error.png'), '-r300', '-png', '-painters');
...
legend('boxoff');
title('1548');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_datasample.png'), '-r300', '-png', '-painters');
% plot scatter plot of modeled return intensity.
...
title('1548');
legend('boxoff');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_data_sample_scatter_plot.png'), '-r300', ...
           '-png', '-painters');
% apparent reflectance
...
ylabel('\rho_{app}');
title('1548');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_data_sample_apprefl_range.png'), '-r300', '-png', '-painters');
% % plot histogram of apparent reflectance errors and error v.s. range together
% figure();
% subplot(2, 1, 1);
...
% title('1548');
% legend('boxoff');
% export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_data_sample_apprefl_error.png'), '-r300', '-png', '-painters');
% % plot errors in apparent reflectance against range, expect no trend
% figure();
% export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_data_sample_apprefl_error_range.png'), '-r300', '-png', '-painters');
figure('Position', [0, 0, 2.17, 1.73]);
%subplot(1, 2, 1);
...
title('1548');
legend('boxoff');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_data_sample_apprefl_error_hist.png'), '-r300', '-png', '-painters');
