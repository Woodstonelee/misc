...
export_fig('cal_dwel_gm_20140812_1064_average_data.png', '-r300', '-png', '-painters');
figure();
...
export_fig('cal_dwel_gm_20140812_1064_average_data_fitting_error.png', '-r300', '-png', '-painters');
% plot original data points before averaging. 
[~, model1064] = dwel_gm_plot(data1064, fitp1064);
title(sprintf('20140812, 1064, Generalized logistic model fitting \nraw data points'));
export_fig('cal_dwel_gm_20140812_1064_raw_data.png', '-r300', '-png', '-painters');
figure();
plot(data1064(:, 1), (data1064(:,3)-model1064)./data1064(:,3), '.')
title(sprintf('20140812, 1064, Relative errors of generalized logistic model fitting \nraw data points'));
xlabel('range');
ylabel('Relative error in return intensity');
legend('(data - model) / data');
export_fig('cal_dwel_gm_20140812_1064_raw_data_fitting_error.png', '-r300', ...
           '-png', '-painters');
% plot scatter plot
...
export_fig('cal_dwel_gm_20140812_1064_raw_data_scatter_plot.png', '-r300', ...
           '-png', '-painters');
...
title(sprintf(['20140812, 1548, Generalized logistic model fitting to data points \naveraged ' ...
       'at each range locations']));
export_fig('cal_dwel_gm_20140812_1548_average_data.png', '-r300', '-png', '-painters');
figure();
...
ylabel('Relative error in return intensity');
legend('(data - model) / data');
export_fig('cal_dwel_gm_20140812_1548_average_data_fitting_error.png', '-r300', '-png', '-painters');
% plot original data points before averaging. 
[~, model1548] = dwel_gm_plot(data1548, fitp1548);
title(sprintf('20140812, 1548, Generalized logistic model fitting \nraw data points'));
export_fig('cal_dwel_gm_20140812_1548_raw_data.png', '-r300', '-png', '-painters');
figure();
plot(data1548(:, 1), (data1548(:,3)-model1548)./data1548(:,3), '.')
title(sprintf('20140812, 1548, Relative errors of generalized logistic model fitting \nraw data points'));
xlabel('range');
ylabel('Relative error in return intensity');
legend('(data - model) / data');
export_fig('cal_dwel_gm_20140812_1548_raw_data_fitting_error.png', '-r300', ...
           '-png', '-painters');
% plot scatter plot
