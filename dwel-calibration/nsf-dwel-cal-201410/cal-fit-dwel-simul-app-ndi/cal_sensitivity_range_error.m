...
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1064_sensitivity_intensity_error.png'), '-r300', '-png', '-painters');
...
% pos(2) = pos(2)-7.5;
% set(htitle, 'position', pos);
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1064_sensitivity_range_error.png'), '-r300', '-png', '-painters');
% plot error over range at +5 DN error
tmpflag = 21;
figure('Position', figsize);
...
% pos(2) = pos(2)-7.5;
% set(htitle, 'position', pos);
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_sensitivity_intensity_error.png'), '-r300', '-png', '-painters');
% plot error over range at +5 DN error
tmpflag = int_delta_mesh(:, 1)==5;
figure('Position', figsize);
plot(r, rhoerr_int_mesh(tmpflag, :))
...
% pos(2) = pos(2)-7.5;
% set(htitle, 'position', pos);
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_sensitivity_range_error.png'), '-r300', '-png', '-painters');
% plot error over range at +5 DN error
tmpflag = 21;
figure('Position', figsize);
plot(r, rhoerr_r_mesh(tmpflag, :))
...
hold on;
hcb = colorbar('southoutside');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_sr_sensitivity_nir_swir_range_error.png'), '-r300', '-png', '-painters');
...
hold on;
hcb = colorbar('southoutside');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_sr_sensitivity_nir_range_error.png'), '-r300', '-png', '-painters');
...
hold on;
hcb = colorbar('southoutside');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_sr_sensitivity_swir_range_error.png'), '-r300', '-png', '-painters');
...
hold on;
hcb = colorbar('southoutside');
export_fig(fullfile(outdir, 'cal_dwel_gm_20140812_1548_ndi_sensitivity_nir_swir_range_error.png'), '-r300', '-png', '-painters');
