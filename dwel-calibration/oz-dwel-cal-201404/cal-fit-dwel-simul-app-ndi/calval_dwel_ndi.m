...
indir = '/usr3/graduate/zhanli86/Programs/misc/dwel-calibration/oz-dwel-cal-201404/cal-simul-appndi-oz-20140425-outputs-v20150201';
...
if detrendflag
    ...
    fid = fopen(fullfile(outdir, 'cal_dwel_simul_appndi_20140425_pwreg1st_range_vs_ndi.txt'), 'w');
...
xlabel('range')
ylabel('Panel NDI')
export_fig(fullfile(outdir, 'cal_dwel_simul_appndi_20140425_ndi_vs_range.png'), '-png', '-r300', '-painters');
...
export_fig(fullfile(outdir, 'cal_dwel_simul_appndi_20140425_1064_apprefl_vs_range.png'), '-png', '-r300', '-painters');
...
export_fig(fullfile(outdir, 'cal_dwel_simul_appndi_20140425_1548_apprefl_vs_range.png'), '-png', '-r300', '-painters');
