...
#$ -l mem_total=8
#$ -l h_rt=72:00:00
#$ -N dwel-wf-processing-uml20150917
#$ -V
#$ -m ae
#$ -t 1-2
...
HDF5FILES=( \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150917/Scan1/waveform_2015-09-17-17-02.hdf5" \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150917/Scan1/waveform_2015-09-17-17-02.hdf5" \
)

CONFIGFILES=( \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150917/Scan1/config_2010-01-02-09-36-24.cfg" \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150917/Scan1/config_2010-01-02-09-36-24.cfg" \
)

CUBEFILES=( \
"/projectnb/echidna/lidar/DWEL_Processing/DWEL_TestCal/uml-lab-test-20150917/scan1/waveform_2015-09-17-17-02_1064.img" \
"/projectnb/echidna/lidar/DWEL_Processing/DWEL_TestCal/uml-lab-test-20150917/scan1/waveform_2015-09-17-17-02_1548.img" \
)
