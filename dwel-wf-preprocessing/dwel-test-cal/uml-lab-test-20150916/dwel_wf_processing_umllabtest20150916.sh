...
#$ -l mem_total=8
#$ -l h_rt=72:00:00
#$ -N dwel-wf-processing-uml20150916
#$ -V
#$ -m ae
#$ -t 1-4
...
HDF5FILES=( \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150916/Scan1/waveform_2015-09-16-14-50.hdf5" \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150916/Scan2/waveform_2015-09-16-15-00.hdf5" \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150916/Scan1/waveform_2015-09-16-14-50.hdf5" \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150916/Scan2/waveform_2015-09-16-15-00.hdf5" \
)

CONFIGFILES=( \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150916/Scan1/config_2010-01-02-04-38-50.cfg" \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150916/Scan2/config_2010-01-02-04-48-33.cfg" \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150916/Scan1/config_2010-01-02-04-38-50.cfg" \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/uml-lab-test-20150916/Scan2/config_2010-01-02-04-48-33.cfg" \
)

CUBEFILES=( \
"/projectnb/echidna/lidar/DWEL_Processing/DWEL_TestCal/uml-lab-test-20150916/scan1/waveform_2015-09-16-14-50_1064_cube.img" \
"/projectnb/echidna/lidar/DWEL_Processing/DWEL_TestCal/uml-lab-test-20150916/scan2/waveform_2015-09-16-15-00_1064_cube.img" \
"/projectnb/echidna/lidar/DWEL_Processing/DWEL_TestCal/uml-lab-test-20150916/scan1/waveform_2015-09-16-14-50_1548_cube.img" \
"/projectnb/echidna/lidar/DWEL_Processing/DWEL_TestCal/uml-lab-test-20150916/scan2/waveform_2015-09-16-15-00_1548_cube.img" \
)
