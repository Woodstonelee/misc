...
#$ -l mem_total=8
#$ -l h_rt=24:00:00
#$ -N dwel-wf-processing-lab-test-20140815
#$ -V
#$ -m ae
#$ -t 1-2

HDF5FILES=( \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/Aug15_Lab_NSF/waveform_2014-08-15-13-45.hdf5" \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/Aug15_Lab_NSF/waveform_2014-08-15-13-45.hdf5" \
)

CONFIGFILES=( \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/Aug15_Lab_NSF/config_2010-01-05-09-42-00.cfg" \
"/projectnb/echidna/lidar/Data_DWEL_TestCal/Aug15_Lab_NSF/config_2010-01-05-09-42-00.cfg" \
)

CUBEFILES=( \
"/projectnb/echidna/lidar/DWEL_Processing/DWEL_TestCal/uml-lab-test-20140815/uml_lab_test_20140815_1064_cube.img" \
"/projectnb/echidna/lidar/DWEL_Processing/DWEL_TestCal/uml-lab-test-20140815/uml_lab_test_20140815_1548_cube.img" \
)
